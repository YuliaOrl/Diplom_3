...
class MainPageLocators:
    CONSTRUCTOR_TITLE = By.XPATH, './/h1[contains(@class, "text_type_main-large")]'  # Заголовок страницы конструктора
    PERSONAL_PAGE_BUTTON = By.XPATH, './/p[text()="Личный Кабинет"]'  # Кнопка "Личный кабинет" на главной странице
    ENTER_ACCOUNT_BUTTON = By.XPATH, './/button[text()="Войти в аккаунт"]'  # Кнопка "Войти в аккаунт" на главной странице
    ...
    BASE_INGREDIENT_WINDOW = './/p[starts-with(@class, "text") and contains(text(), "{}")]/parent::div/parent::div/parent::section'
